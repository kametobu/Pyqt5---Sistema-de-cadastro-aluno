...
# Form implementation generated from reading ui file 'CadAtiv.ui'
#
...
"background-size: cover;")
        ...
        self.pushButton_Recar = QtWidgets.QPushButton(self.frame_23)
        ...
        self.horizontalLayout_16.addWidget(self.pushButton_Recar)
        self.pushButton_logado = QtWidgets.QPushButton(self.frame_23)
        ...
        self.pushButton_Sair = QtWidgets.QPushButton(self.frame_23)
...
"}")
        ...
        self.label_Atividade = QtWidgets.QLabel(self.frame_17)
        self.label_Atividade.setMinimumSize(QtCore.QSize(30, 0))
        self.label_Atividade.setMaximumSize(QtCore.QSize(65, 20))
        self.label_Atividade.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgb(43, 43, 43);\n"
"font: 87 8pt \"Arial Black\";\n"
"")
        self.label_Atividade.setAlignment(QtCore.Qt.AlignCenter)
        self.label_Atividade.setObjectName("label_Atividade")
        self.verticalLayout_3.addWidget(self.label_Atividade)
        self.lineEdit_Atividade = QtWidgets.QLineEdit(self.frame_17)
        self.lineEdit_Atividade.setMinimumSize(QtCore.QSize(180, 25))
        self.lineEdit_Atividade.setMaximumSize(QtCore.QSize(250, 16777215))
        self.lineEdit_Atividade.setStyleSheet("QLineEdit{\n"
...
"}")
        self.lineEdit_Atividade.setObjectName("lineEdit_Atividade")
        self.verticalLayout_3.addWidget(self.lineEdit_Atividade)
...
"}")
        ...
        self.pushButton_Atua = QtWidgets.QPushButton(self.frame_15)
        self.pushButton_Atua.setMinimumSize(QtCore.QSize(80, 25))
        self.pushButton_Atua.setMaximumSize(QtCore.QSize(80, 16777215))
        self.pushButton_Atua.setStyleSheet("QPushButton{\n"
"background-repeat: no-repeat;\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 10px;\n"
"background-color: rgb(97, 97, 97);\n"
...
"    \n"
"}")
        self.pushButton_Atua.setObjectName("pushButton_Atua")
        self.horizontalLayout_12.addWidget(self.pushButton_Atua)
        self.pushButton_Can = QtWidgets.QPushButton(self.frame_15)
        self.pushButton_Can.setMinimumSize(QtCore.QSize(80, 25))
        self.pushButton_Can.setMaximumSize(QtCore.QSize(80, 16777215))
        self.pushButton_Can.setStyleSheet("QPushButton{\n"
"background-repeat: no-repeat;\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 10px;\n"
"background-color: rgb(97, 97, 97);\n"
...
"}")
        ...
        self.horizontalLayout_12.addWidget(self.pushButton_Can)
...
"border-radius: 5px;")
        ...
        self.lineEdit_PesAtv = QtWidgets.QLineEdit(self.frame_9)
        self.lineEdit_PesAtv.setMinimumSize(QtCore.QSize(160, 25))
        self.lineEdit_PesAtv.setMaximumSize(QtCore.QSize(200, 16777215))
        self.lineEdit_PesAtv.setStyleSheet("QLineEdit{\n"
"background-color: rgb(216, 216, 216);\n"
"border-radius: 2px;\n"
"padding: 0px 10px;\n"
"border: 1px solid  rgb(0, 0, 0);\n"
...
"border: 1px solid  rgb(33, 122, 255);\n"
"}")
        self.lineEdit_PesAtv.setObjectName("lineEdit_PesAtv")
        self.horizontalLayout_8.addWidget(self.lineEdit_PesAtv)
        self.pushButton_Pesqui = QtWidgets.QPushButton(self.frame_9)
        self.pushButton_Pesqui.setMinimumSize(QtCore.QSize(120, 25))
        self.pushButton_Pesqui.setMaximumSize(QtCore.QSize(120, 16777215))
        self.pushButton_Pesqui.setStyleSheet("QPushButton{\n"
...
"    \n"
"}")
        self.pushButton_Pesqui.setObjectName("pushButton_Pesqui")
        self.horizontalLayout_8.addWidget(self.pushButton_Pesqui)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_menu.setShortcut(_translate("MainWindow", "Ctrl+S"))
        ...
        self.pushButton_Unidade.setText(_translate("MainWindow", " Unidades"))
        ...
        self.label_Atividade.setText(_translate("MainWindow", "Atividade"))
        self.lineEdit_Atividade.setPlaceholderText(_translate("MainWindow", "Atividade"))
        self.pushButton_Cad.setText(_translate("MainWindow", "Cadastrar"))
        self.pushButton_Atua.setText(_translate("MainWindow", "Atualizar"))
        self.pushButton_Can.setText(_translate("MainWindow", "Cancelar"))
        self.pushButton_Deletar.setText(_translate("MainWindow", "Deletar"))
        self.label_2.setText(_translate("MainWindow", "Quantidade: 0"))
        self.lineEdit_PesAtv.setPlaceholderText(_translate("MainWindow", "Atividade"))
        self.pushButton_Pesqui.setText(_translate("MainWindow", "Pesquisar"))
