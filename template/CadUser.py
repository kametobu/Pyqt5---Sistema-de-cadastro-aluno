...
# Form implementation generated from reading ui file 'CadUser.ui'
#
...
class Ui_User(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_14 = QtWidgets.QVBoxLayout(self.btnMenu)
...
"")
        ...
        self.verticalLayout_14.addWidget(self.pushButton_menu)
...
"background-size: cover;")
        ...
        self.horizontalLayout_13.addWidget(self.pushButton_Recar)
        ...
        self.horizontalLayout_13.addWidget(self.pushButton_Logado)
        ...
        self.horizontalLayout_13.addWidget(self.pushButton_Sair)
...
"}")
        ...
        self.frame_3.setSizeIncrement(QtCore.QSize(1, 0))
        ...
        self.Labelimg = QtWidgets.QLabel(self.frame_3)
        self.Labelimg.setMinimumSize(QtCore.QSize(95, 100))
        self.Labelimg.setStyleSheet("border:2px solid rgb(43, 43, 43);\n"
"border-radius: 10px;")
        self.Labelimg.setText("")
        self.Labelimg.setObjectName("Labelimg")
        self.verticalLayout_3.addWidget(self.Labelimg)
        self.ImgSrc = QtWidgets.QLabel(self.frame_3)
        self.ImgSrc.setMinimumSize(QtCore.QSize(100, 20))
        self.ImgSrc.setStyleSheet("border:2px solid rgb(43, 43, 43);\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 10px;")
        self.ImgSrc.setText("")
        self.ImgSrc.setObjectName("ImgSrc")
        self.verticalLayout_3.addWidget(self.ImgSrc)
        self.btnBuscar = QtWidgets.QPushButton(self.frame_3)
        self.btnBuscar.setMinimumSize(QtCore.QSize(60, 25))
        self.btnBuscar.setStyleSheet("QPushButton{\n"
"background-image: url(:/img/img/cam.png);\n"
...
"}")
        ...
        self.verticalLayout_3.addWidget(self.btnBuscar)
        ...
        self.Nome = QtWidgets.QLabel(self.frame_7)
        self.Nome.setMaximumSize(QtCore.QSize(50, 20))
...
"")
        ...
        self.lineEdit_Nome.setMinimumSize(QtCore.QSize(150, 20))
...
"}")
        ...
        self.verticalLayout_4.addWidget(self.lineEdit_Nome)
        self.gridLayout.addLayout(self.verticalLayout_4, 0, 0, 1, 1)
        self.verticalLayout_7 = QtWidgets.QVBoxLayout()
        self.verticalLayout_7.setSpacing(0)
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.Login = QtWidgets.QLabel(self.frame_7)
        self.Login.setMinimumSize(QtCore.QSize(0, 0))
        self.Login.setMaximumSize(QtCore.QSize(50, 20))
...
"")
        ...
        self.lineEdit_Login.setMinimumSize(QtCore.QSize(150, 20))
...
"}")
        ...
        self.verticalLayout_7.addWidget(self.lineEdit_Login)
        self.gridLayout.addLayout(self.verticalLayout_7, 0, 1, 1, 1)
        self.verticalLayout_10 = QtWidgets.QVBoxLayout()
        self.verticalLayout_10.setSpacing(0)
        self.verticalLayout_10.setObjectName("verticalLayout_10")
        self.label_CPF = QtWidgets.QLabel(self.frame_7)
        self.label_CPF.setMaximumSize(QtCore.QSize(50, 20))
...
"")
        ...
        self.verticalLayout_10.addWidget(self.label_CPF)
        self.lineEdit_CPF = QtWidgets.QLineEdit(self.frame_7)
        self.lineEdit_CPF.setMinimumSize(QtCore.QSize(150, 20))
...
"}")
        ...
        self.verticalLayout_10.addWidget(self.lineEdit_CPF)
        self.gridLayout.addLayout(self.verticalLayout_10, 0, 2, 1, 1)
        self.verticalLayout_5 = QtWidgets.QVBoxLayout()
        self.verticalLayout_5.setSpacing(0)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.Senha = QtWidgets.QLabel(self.frame_7)
        self.Senha.setMinimumSize(QtCore.QSize(0, 0))
        self.Senha.setMaximumSize(QtCore.QSize(50, 20))
        self.Senha.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgb(43, 43, 43);\n"
"font: 87 8pt \"Arial Black\";\n"
"")
        self.Senha.setAlignment(QtCore.Qt.AlignCenter)
        self.Senha.setObjectName("Senha")
        self.verticalLayout_5.addWidget(self.Senha)
        self.lineEdit_Senha = QtWidgets.QLineEdit(self.frame_7)
        self.lineEdit_Senha.setMinimumSize(QtCore.QSize(150, 20))
...
"}")
        ...
        self.verticalLayout_5.addWidget(self.lineEdit_Senha)
        self.gridLayout.addLayout(self.verticalLayout_5, 1, 0, 1, 1)
        self.verticalLayout_8 = QtWidgets.QVBoxLayout()
        self.verticalLayout_8.setSpacing(0)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.Atividade = QtWidgets.QLabel(self.frame_7)
        self.Atividade.setMinimumSize(QtCore.QSize(0, 0))
        self.Atividade.setMaximumSize(QtCore.QSize(70, 20))
        self.Atividade.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgb(43, 43, 43);\n"
"font: 87 8pt \"Arial Black\";\n"
"")
        self.Atividade.setAlignment(QtCore.Qt.AlignCenter)
        self.Atividade.setObjectName("Atividade")
        self.verticalLayout_8.addWidget(self.Atividade)
        self.comboBox_Atividade = QtWidgets.QComboBox(self.frame_7)
        self.comboBox_Atividade.setMinimumSize(QtCore.QSize(150, 20))
        self.comboBox_Atividade.setStyleSheet("\n"
"\n"
"QComboBox{\n"
"background-color: rgb(216, 216, 216);\n"
"border-radius: 2px;\n"
...
"border: 1px solid  rgb(33, 122, 255);\n"
"}")
        self.comboBox_Atividade.setObjectName("comboBox_Atividade")
        self.verticalLayout_8.addWidget(self.comboBox_Atividade)
        self.gridLayout.addLayout(self.verticalLayout_8, 1, 1, 1, 1)
        self.verticalLayout_6 = QtWidgets.QVBoxLayout()
        self.verticalLayout_6.setSpacing(0)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.Email = QtWidgets.QLabel(self.frame_7)
        self.Email.setMinimumSize(QtCore.QSize(0, 0))
        self.Email.setMaximumSize(QtCore.QSize(50, 20))
...
"")
        ...
        self.lineEdit_Email = QtWidgets.QLineEdit(self.frame_7)
        self.lineEdit_Email.setMinimumSize(QtCore.QSize(150, 20))
...
"}")
        ...
        self.Atividade_curso = QtWidgets.QLabel(self.frame_7)
        self.Atividade_curso.setMinimumSize(QtCore.QSize(0, 0))
        self.Atividade_curso.setMaximumSize(QtCore.QSize(70, 20))
        self.Atividade_curso.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgb(43, 43, 43);\n"
"font: 87 8pt \"Arial Black\";\n"
"")
        self.Atividade_curso.setAlignment(QtCore.Qt.AlignCenter)
        self.Atividade_curso.setObjectName("Atividade_curso")
        self.verticalLayout_15.addWidget(self.Atividade_curso)
        self.comboBox_curso = QtWidgets.QComboBox(self.frame_7)
        self.comboBox_curso.setMinimumSize(QtCore.QSize(150, 20))
        self.comboBox_curso.setStyleSheet("\n"
"\n"
"QComboBox{\n"
"background-color: rgb(216, 216, 216);\n"
"border-radius: 2px;\n"
...
"}")
        ...
        self.verticalLayout_15.addWidget(self.comboBox_curso)
        self.gridLayout.addLayout(self.verticalLayout_15, 2, 1, 1, 1)
        self.verticalLayout_9 = QtWidgets.QVBoxLayout()
        self.verticalLayout_9.setSpacing(0)
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.Atividade_2 = QtWidgets.QLabel(self.frame_7)
        self.Atividade_2.setMinimumSize(QtCore.QSize(0, 0))
        self.Atividade_2.setMaximumSize(QtCore.QSize(70, 20))
        self.Atividade_2.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgb(43, 43, 43);\n"
"font: 87 8pt \"Arial Black\";\n"
"")
        self.Atividade_2.setAlignment(QtCore.Qt.AlignCenter)
        self.Atividade_2.setObjectName("Atividade_2")
        self.verticalLayout_9.addWidget(self.Atividade_2)
        self.comboBox_Atividade_2 = QtWidgets.QComboBox(self.frame_7)
        self.comboBox_Atividade_2.setMinimumSize(QtCore.QSize(150, 20))
        self.comboBox_Atividade_2.setStyleSheet("\n"
"\n"
"QComboBox{\n"
"background-color: rgb(216, 216, 216);\n"
"border-radius: 2px;\n"
...
"border: 1px solid  rgb(33, 122, 255);\n"
"}")
        self.comboBox_Atividade_2.setObjectName("comboBox_Atividade_2")
        self.verticalLayout_9.addWidget(self.comboBox_Atividade_2)
...
"background-image: url(:/img/img/cad.png);\n"
"background-position: left;\n"
"background-repeat: no-repeat;\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 10px;\n"
...
"background-image: url(:/img/img/edit.png);\n"
"background-position: left;\n"
"background-repeat: no-repeat;\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 10px;\n"
...
"}")
        ...
        self.label_Quantidade.setGeometry(QtCore.QRect(10, 10, 100, 25))
...
"")
        ...
        self.checkBox_CPF = QtWidgets.QCheckBox(self.frame_17)
        self.checkBox_CPF.setMinimumSize(QtCore.QSize(0, 20))
        self.checkBox_CPF.setMaximumSize(QtCore.QSize(50, 16777215))
        self.checkBox_CPF.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgb(43, 43, 43);\n"
"font: 87 8pt \"Arial Black\";\n"
"border-radius: 2px;\n"
"")
        self.checkBox_CPF.setObjectName("checkBox_CPF")
        self.horizontalLayout_10.addWidget(self.checkBox_CPF)
        self.checkBox_RA = QtWidgets.QCheckBox(self.frame_17)
        self.checkBox_RA.setMinimumSize(QtCore.QSize(0, 20))
        self.checkBox_RA.setMaximumSize(QtCore.QSize(50, 16777215))
        self.checkBox_RA.setStyleSheet("QCheckBox{\n"
"color: rgb(255, 255, 255);\n"
"background-color: rgb(43, 43, 43);\n"
"font: 87 8pt \"Arial Black\";\n"
"border-radius: 2px;\n"
...
"")
        ...
        self.horizontalLayout_10.addWidget(self.checkBox_RA)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Login.setText(_translate("MainWindow", "R.A."))
        self.lineEdit_Login.setPlaceholderText(_translate("MainWindow", "R.A."))
        ...
        self.Atividade.setText(_translate("MainWindow", "Atividade"))
        self.Email.setText(_translate("MainWindow", "E-mail"))
        self.lineEdit_Email.setPlaceholderText(_translate("MainWindow", "e-mail"))
        self.Atividade_curso.setText(_translate("MainWindow", "Curso"))
        self.Atividade_2.setText(_translate("MainWindow", "Unidade"))
        ...
        self.checkBox_CPF.setText(_translate("MainWindow", "CPF"))
        self.checkBox_RA.setText(_translate("MainWindow", "R.A."))
        self.lineEdit_Pesquisa.setPlaceholderText(_translate("MainWindow", "Nome"))
